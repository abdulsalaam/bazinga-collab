...
const script1 = `Baziga is a private and secure real-time collaborative text editor. Baziga
...
Kind of, but Baziga is decentralized and therefore private. Google stores your
documents on their servers where they and the government could access them. With
Baziga, your document is stored only on your computer and any changes you make
are sent only to the people collaborating with you. Also Google is pretty big.
We're just three engineers who created Baziga in a month. Click *Our Team* above
to learn more about us.

### What Else Can Baziga Do?
...
const bot1 = new UserBot('baziga-bot'+id, 'baziga-demo-'+id, script1, demo.editor.mde);
bot1.runScript(75);
